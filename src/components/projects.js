...
const Projects = ({ returnSection, color }) => {
  ...
  return (
    <section
      className="project animate__animated animate__slideInLeft"
      style={expand}
    >
      <div>
        <button
      ...
      <a
        href="https://github.com/BrunoSapalacio?tab=repositories"
        target="_blank"
        rel="noreferrer"
        className="btn-projects tooltip"
      >
        Ver mais projetos!
        <span className="tooltiptext">
          Clique aqui para ver todos os meus projetos
        </span>
      </a>
    </section>
  );
