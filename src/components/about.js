      ...
      <div className="content-about">
        ...
        <div className="formation-card">
          ...
          <div>
            ...
            <p>
              ...
              gerenciar equipes de desenvolvimento de sistemas, diagnosticar
              problemas e propor melhorias baseadas em sistemas computacionais,
              aplicar adequadamente recursos computacionais (hardware e
              software), projetar e implementar Sistemas de Informação aderentes
              aos objetivos estratégicos das organizações, produzir software
              utilizando métodos e técnicas adequadas, visando a alcançar os
              atributos essenciais de software.
            </p>
          </div>
        </div>
        <div className="formation-card">
          ...
          <div>
            ...
            <p>
              Curso de linguagem JavaScript, voltado para iniciantes e para quem
              quiser aprender mais sobre ECMAScript, a versão padronizada do JS.
              É um curso patrocinado pelo Google e apresentado pelo professor
              Gustavo Guanabara, no qual ensina o conteúdo básico de JavaScript
              em 6 módulos, que vão desde o conhecimento da linguagem até o uso
              de funções.
            </p>
          </div>
        </div>
        <div className="formation-card">
          ...
          <div>
            ...
            <p>
              Conceitos principais de JavaScript moderno, instalação e
              configuração do ambiente, instalação de pacotes usando Node
              Package Manager, fazer requisições HTTP em APIs Web, principais
              métodos de ciclo de vida de um componente React, hooks, fazer
              rotas, Redux, validação de Formulários, Formik, Yup, fazer Deploy
              da sua aplicação React em um servidor.
            </p>
          </div>
        </div>
        <div className="formation-card">
          ...
          <div>
            ...
            <p>
              Revisão de Flexbox, CSS Grid Layout, aprender a como utilizar o
              Sass(um pré-processador de CSS que nos permite escrever classes
              CSS de maneira programática) e por último, o que são os CSS
              Modules.
            </p>
          </div>
        </div>
